...
function agregarStringInvertida() {
  ...
  String.prototype.reverse = function() {
      //STR = HOLA --> STR.SPLI("") = [h,o,l,a]
     var separated = this.split(""); 
     var inverter  = separated.reverse(); //[a,l,o,h]
     var result    = inverter.join("") //result = "aloh"
     return result
  }
  //return this.split("").reverse().join("") ESTA ES UNA FORMA DE ESCRIBIR LO DE ARRIBA MÁS CONCISO. 
